...
{
    public partial class ItemsCollection : Form
    {
        ...
        private void ItemsCollection_Load(object sender, EventArgs e)
        {
                ...
                new SqlConnection("Data Source=(local);Initial Catalog=BD2;Integrated Security=SSPI"))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("selectIdsFromCartByUser", conn))
                {
